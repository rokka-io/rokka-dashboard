...
const CropForm = ({ onChange, x = '', y = '', width = '', height = '', disableWidthHeight = false }) => (
  <div className="row">
    ...
    <div className="col-md-3 col-sm-3">
      <div className="rka-form-group">
        ...
        <input type="text" name="width" disabled={disableWidthHeight} className="rka-input-txt" value={width} onChange={onChange} />
      </div>
    </div>
    <div className="col-md-3 col-sm-3">
      <div className="rka-form-group">
        <label className="rka-label">Height</label>
        <input type="text" name="height" disabled={disableWidthHeight} className="rka-input-txt" value={height} onChange={onChange} />
      </div>
    </div>
  </div>
)
