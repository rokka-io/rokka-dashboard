    ...
    return (
      <div className="row">
        <div className="col-md-4">
          <FormGroup
            label="Horizontal"
            required={this.isRequired('horizontal')}
            error={errors.horizontal}
          >
            <InputRange
              name="horizontal"
              min={defaults.horizontal.minimum}
              max={defaults.horizontal.maximum}
              value={values.horizontal}
              defaultValue={defaults.horizontal.default}
        ...
        <div className="col-md-4">
          <FormGroup
            label="Vertical"
            required={this.isRequired('vertical')}
            error={errors.vertical}
          >
            <InputRange
              name="vertical"
              min={defaults.vertical.minimum}
              max={defaults.vertical.maximum}
              value={values.vertical}
              defaultValue={defaults.vertical.default}
              onChange={this.props.onChange}
            />
          </FormGroup>
        </div>
        <div className="col-md-4">
          <FormGroup label="Opacity" required={this.isRequired('opacity')} error={errors.opacity}>
            <InputRange
              name="opacity"
              min={defaults.opacity.minimum}
              max={defaults.opacity.maximum}
              value={values.opacity}
              defaultValue={defaults.opacity.default}
              onChange={this.props.onChange}
            />
          </FormGroup>
        </div>
        <div className="col-md-4">
          <FormGroup label="Color" required={this.isRequired('color')} error={errors.color}>
            <InputColor
              name="color"
              value={values.color}
              defaultValue={defaults.color.default}
              onChange={this.props.onChange}
            />
          </FormGroup>
        </div>
        <div className="col-md-4">
          <FormGroup
            label="Blur radius"
            required={this.isRequired('blur_radius')}
            error={errors.blur_radius}
          >
            <InputRange
              name="blur_radius"
              min={defaults.blur_radius.minimum}
              max={defaults.blur_radius.maximum}
              value={values.blur_radius}
              defaultValue={defaults.blur_radius.default}
              onChange={this.props.onChange}
            />
          </FormGroup>
        </div>
