      ...
      <div className="row">
        <div className="col-md-12">
          <FormGroup label="Angle" required={this.isRequired('angle')} error={errors.angle}>
            <InputRange
              name="angle"
              min={defaults.angle.minimum}
              max={defaults.angle.maximum}
              value={values.angle}
              defaultValue={defaults.angle.default}
        ...
        <div className="col-md-6">
          <FormGroup
            ...
            required={this.isRequired('background_color')}
            error={errors.color}
          >
            <InputColor
              name="background_color"
              value={values.background_color}
              defaultValue={defaults.background_color.default}
              onChange={this.props.onChange}
            />
          </FormGroup>
        </div>
        <div className="col-md-6">
          <FormGroup
            ...
            required={this.isRequired('background_opacity')}
            error={errors.background_opacity}
          >
            <InputRange
